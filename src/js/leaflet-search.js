...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyLoc: 'shape_id',			//field for remapping location, using array: ['latname','lonname'] for select double fields(ex. ['lat','lon'] )
		...
		text: 'Enter bus route to search...',			//placeholder value	
		textCancel: 'Cancel',		//title in cancel button
		textErr: 'Bus route not found.',	//error message
		position: 'topleft',
...
//	in this mode every record can have a free structure of attributes, only 'loc' is required
	...
	initialize: function(options) {
		...
		this._inputMinSize = this.options.text ? this.options.text.length : 1;
